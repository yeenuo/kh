...
exports.app = function (req, res, next) {
    console.log("app");
    res.redirect('/public/a/index.html');
};
...
exports.data = function (req, res, next) {
    ...
    if (option == "s")//添加
    {
        ...
        db.q("SELECT ID as id,Title as title,Lat as lat,Lng as lng,Info as info,Point as point,Status as status,Type as type FROM REN.H_" + req.body.model.toUpperCase(), [], function (datas) {
            res.writeHead(200, {"Content-Type": "text/html;charset:utf-8"});
